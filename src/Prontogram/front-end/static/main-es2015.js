...
/* harmony import */ var _notification__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./notification */ "./src/app/_models/notification.ts");
...
/* harmony import */ var _subscription__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./subscription */ "./src/app/_models/subscription.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Subscription", function() { return _subscription__WEBPACK_IMPORTED_MODULE_3__["Subscription"]; });

/* harmony import */ var _flight__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./flight */ "./src/app/_models/flight.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Flight", function() { return _flight__WEBPACK_IMPORTED_MODULE_4__["Flight"]; });

/* harmony import */ var _airport__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./airport */ "./src/app/_models/airport.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Airport", function() { return _airport__WEBPACK_IMPORTED_MODULE_5__["Airport"]; });
...
class AccountService {
    ...
    login(username, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/auth/login`, { username, password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(user => {
            this.userSubject.next(user);
            this.header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("auth-token", this.userSubject.value.token);
    ...
    register(user) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/auth/register`, user);
    }
    createUser(user) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/new`, user, { headers: this.getheader() });
    }
    getAll() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/all`, { headers: this.getheader() });
    }
    getById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/${id}`, { headers: this.getheader() });
    }
    update(id, params) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/${id}`, params, { headers: this.getheader() })
    ...
    delete(id) {
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/${id}`, { headers: this.getheader() })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(x => {
...
/* harmony import */ var _notification_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notification.service */ "./src/app/_services/notification.service.ts");
...
class NotificationService {
    ...
    createNotification(notification) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/notification/new`, notification);
    }
    getAll(username) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/notification/all/${username}`);
    }
    getById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/notification/findOne/${id}`);
    }
    update(id, params) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/notification/${id}`, params);
    }
    delete(id) {
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/notification/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(x => {
            return x;
        }));
    }
    sendSubscriptionToTheServer(subscription, user) {
        const sub = new _models__WEBPACK_IMPORTED_MODULE_5__["Subscription"]();
        sub.subscription = subscription;
        sub.username = user.username;
        console.log(sub);
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/subscription/new`, sub);
    }
    unsubscribeToNotification(subscription) {
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/subscription/${subscription.toJSON()}`);
    }
    send() {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl}/notification/news`, null);
    }
}
...
/* harmony import */ var _notification__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./notification */ "./src/app/notification/index.ts");
...
const routes = [
    ...
    { path: 'users', loadChildren: usersModule, canActivate: [_helpers__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
    { path: 'account', loadChildren: accountModule },
    { path: 'notification', component: _notification__WEBPACK_IMPORTED_MODULE_3__["NotificationComponent"], canActivate: [_helpers__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
...
class AppComponent {
    constructor(accountService, notificationService, swUpdate, swPush) {
        this.accountService = accountService;
    ...
    unsubscribeNotifications() {
        this.swPush.subscription.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(subscriptionValue => {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app"]], decls: 4, vars: 4, consts: [["class", "navbar navbar-expand navbar-dark bg-dark", 4, "ngIf"], [1, "app-container", 3, "ngClass"], [1, "navbar", "navbar-expand", "navbar-dark", "bg-dark"], [1, "navbar-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", "nav-link", 3, "routerLinkActiveOptions"], ["routerLink", "/users", "routerLinkActive", "active", 1, "nav-item", "nav-link"], ["routerLink", "/notification", "routerLinkActive", "active", 1, "nav-item", "nav-link"], [1, "nav-item", "nav-link", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgClass"], _components_alert_component__WEBPACK_IMPORTED_MODULE_5__["AlertComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterOutlet"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkActive"]], encapsulation: 2 });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{ selector: 'app', templateUrl: 'app.component.html' }]
    }], function () { return [{ type: _services__WEBPACK_IMPORTED_MODULE_1__["AccountService"] }, { type: _services__WEBPACK_IMPORTED_MODULE_1__["NotificationService"] }, { type: _angular_service_worker__WEBPACK_IMPORTED_MODULE_2__["SwUpdate"] }, { type: _angular_service_worker__WEBPACK_IMPORTED_MODULE_2__["SwPush"] }]; }, null); })();
...
/* harmony import */ var _notification__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./notification */ "./src/app/notification/index.ts");
...
/* harmony import */ var _app_services__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../app/_services */ "./src/app/_services/index.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_app_services__WEBPACK_IMPORTED_MODULE_10__["AccountService"], _app_services__WEBPACK_IMPORTED_MODULE_10__["NotificationService"]
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
        ...
        _notification__WEBPACK_IMPORTED_MODULE_7__["NotificationComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_8__["ServiceWorkerModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_11__["MatCardModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                ...
                declarations: [
                    ...
                    _components__WEBPACK_IMPORTED_MODULE_6__["AlertComponent"],
                    _notification__WEBPACK_IMPORTED_MODULE_7__["NotificationComponent"]
                ],
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["ng-component"]], decls: 4, vars: 1, consts: [[1, "p-4"], [1, "container"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _notification_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notification.component */ "./src/app/notification/notification.component.ts");
...
function NotificationComponent_div_4_mat_card_subtitle_52_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Citt\u00E0: ", notification_r1.flyBack.departure_airport.cityName, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Citt\u00E0: ", notification_r1.flyBack.arrival_airport.cityName, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
function NotificationComponent_div_4_span_55_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 10);
} }
function NotificationComponent_div_4_span_56_Template(rf, ctx) { if (rf & 1) {
...
function NotificationComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, " \u00E8: ");
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationComponent_div_4_Template_button_click_54_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const notification_r1 = ctx.$implicit; const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.deleteNotification(notification_r1._id); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Citt\u00E0: ", notification_r1.flyOutBound.departure_airport.cityName, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Citt\u00E0: ", notification_r1.flyOutBound.arrival_airport.cityName, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
class NotificationComponent {
    constructor(swPush, notificationService, accountService) {
        this.swPush = swPush;
        this.notificationService = notificationService;
        this.accountService = accountService;
    ...
    ngOnInit() {
        ...
        this.swPush.messages
            ...
            let notify = new _models__WEBPACK_IMPORTED_MODULE_1__["Notification"]();
    ...
    getAllNotifications() {
        this.notificationService.getAll(this.user.username).subscribe((res) => {
...
NotificationComponent.ɵfac = function NotificationComponent_Factory(t) { return new (t || NotificationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_service_worker__WEBPACK_IMPORTED_MODULE_4__["SwPush"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_2__["NotificationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_2__["AccountService"])); };
NotificationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NotificationComponent, selectors: [["ng-component"]], decls: 5, vars: 1, consts: [[1, "p-4"], [1, "container"], [4, "ngFor", "ngForOf"], [2, "background-color", "white", "border", "1px solid rgb(42, 42, 43)", "margin-bottom", "5px"], [1, "table", "table-striped"], [2, "width", "10%"], [2, "width", "35%"], [4, "ngIf"], [1, "btn", "btn-sm", "btn-danger", "btn-delete-user", 3, "click"], ["class", "spinner-border spinner-border-sm", 4, "ngIf"], [1, "spinner-border", "spinner-border-sm"]], template: function NotificationComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "h1");
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["NgForOf"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCard"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardTitle"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardSubtitle"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardContent"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardActions"]], encapsulation: 2 });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NotificationComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{ templateUrl: './notification.component.html' }]
    }], function () { return [{ type: _angular_service_worker__WEBPACK_IMPORTED_MODULE_4__["SwPush"] }, { type: _services__WEBPACK_IMPORTED_MODULE_2__["NotificationService"] }, { type: _services__WEBPACK_IMPORTED_MODULE_2__["AccountService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! D:\Repos\ACMEsky\src\prontogram\front-end\src\main.ts */"./src/main.ts");
