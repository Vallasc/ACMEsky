...
public class GeneratedOffers implements Serializable {
 ...
 @Id
 @Column(name="generated_offer_id",nullable=false,columnDefinition="integer")
 public long getId() {
     return this.id;
 }
 ...
 @Column(name="outbound_flight_id",nullable=false,columnDefinition="integer")
 ...
 @Column(name="flight_back_id",nullable=true,columnDefinition="integer")
 ...
 @Column(name="expire_date",nullable=false,columnDefinition="DATETIME")
 ...
 @Column(name="total_price",nullable=true,columnDefinition="Decimal(10,2)")
 ...
 @Column(name="booked",nullable=true,columnDefinition="boolean default false")
