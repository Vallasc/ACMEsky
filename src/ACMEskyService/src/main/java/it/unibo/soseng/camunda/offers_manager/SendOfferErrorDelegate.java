...
@Named("sendOfferErrorDelegate")
public class SendOfferErrorDelegate implements JavaDelegate {
    private final static Logger LOGGER = Logger.getLogger("sendOfferErrorDelegate"); 
    ...
    public void execute(DelegateExecution execution){
        ...
        LOGGER.info("Execute sendOfferErrorDelegate");
        ...
        if (isValidToken == false || isOfferExpired == true) { 
